...
# Tip of the branch on Jul 7, 2023
SRCREV = "07fdc0799c2f5a1c1b636531cf8f8d260d967e94"
...
SRC_URI += "file://2.38/comcast-DELIA-24951-log-HTML5-video-playback.patch"
...
SRC_URI += "file://2.38/comcast-AMLOGIC-3262-Initial-support-for-instant-rat.patch"
...
PACKAGECONFIG_append = " webcrypto webdriver intl remoteinspector releaselog accessibility speechsynthesis native_video webaudio"
...
# remove once implemented in 2.38 branch
PACKAGECONFIG[hevc] = ""
PACKAGECONFIG[indexeddb] = ""
PACKAGECONFIG_remove = "intl hevc indexeddb"
